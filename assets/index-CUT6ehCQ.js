...
`)}c(IM,"handleSource");const Pg=new Ge;function DM(s){Ze._getMatrix(Pg,Ze.workingColorSpace,s);const e=`mat3( ${Pg.elements.map(t=>t.toFixed(4))} )`;switch(Ze.getTransfer(s)){case Go:return[e,"LinearTransferOETF"];case at:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}c(DM,"getEncodingComponents");function Lg(s,e,t){const n=s.getShaderParameter(e,s.COMPILE_STATUS),i=s.getShaderInfoLog(e).trim();if(n&&i==="")return"";const r=/ERROR: 0:(\d+)/.exec(i);if(r){const o=parseInt(r[1]);return t.toUpperCase()+`
